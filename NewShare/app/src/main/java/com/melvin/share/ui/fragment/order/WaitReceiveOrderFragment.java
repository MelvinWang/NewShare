 ...
 * 描述：待收货
 */
public class WaitReceiveOrderFragment extends BaseFragment implements MyRecyclerView.LoadingListener  {
    ...
    private void initData() {
        ...
        allOrderViewModel= new AllOrderViewModel(mContext, WaitReceiveOrderFragment.this,mRecyclerView);
