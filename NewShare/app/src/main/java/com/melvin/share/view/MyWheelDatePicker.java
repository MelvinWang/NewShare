...
public class MyWheelDatePicker extends LinearLayout implements WheelPicker.OnItemSelectedListener,
    ...
    public MyWheelDatePicker(Context context) {
        this(context, null);
    }

    public MyWheelDatePicker(Context context, AttributeSet attrs) {
        super(context, attrs);

        LayoutInflater.from(context).inflate(R.layout.my_wheel_date_picker, this);
    ...
    public interface OnDateSelectedListener {
        void onDateSelected(MyWheelDatePicker picker, Date date);
    }
}