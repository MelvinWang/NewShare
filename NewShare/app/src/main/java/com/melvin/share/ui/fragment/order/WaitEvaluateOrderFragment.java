 ...
 * 描述：待评价
 */
public class WaitEvaluateOrderFragment extends BaseFragment implements MyRecyclerView.LoadingListener  {
    ...
    private void initData() {
        ...
        allOrderViewModel= new AllOrderViewModel(mContext, WaitEvaluateOrderFragment.this,mRecyclerView);
