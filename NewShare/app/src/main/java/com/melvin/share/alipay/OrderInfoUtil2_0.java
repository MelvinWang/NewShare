...
public class OrderInfoUtil2_0 {
	 ...
	 * @return
	 */
	public static Map<String, String> buildOrderParamMap(String app_id, boolean rsa2,String total_amount,String payOrderNumber,
														 String subject,String body,String time) {
		Map<String, String> keyValues = new HashMap<String, String>();
//		LogUtils.i("getOutTradeNo()"+getOutTradeNo());
//		LogUtils.i("payOrderNumber"+payOrderNumber);
		keyValues.put("app_id", app_id);
