 ...
 * 描述：不能下拉刷新
 */
public class NoRefreshRecyclerView extends RecyclerView {
    ...
    public NoRefreshRecyclerView(Context context) {
        this(context, null);
    }

    public NoRefreshRecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NoRefreshRecyclerView(Context context, AttributeSet attrs, int defStyle) {
